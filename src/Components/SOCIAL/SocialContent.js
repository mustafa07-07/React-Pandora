            ...
            <div className="row">
              <div className="col-lg-6 offset-lg-6 about-text">
                ...
                <p class="text-justify">
                  ...
                  single 10,000 follower profile. Why? Because spreading your
                  brand across multiple influencers allows you to reach more
                ...
                <p class="text-justify">
                  ...
                  our creatives. Our in-house designers, copywriters, and
                  campaign strategists create eye-catching assets with an
                  emotion-driven narrative to spread across our international
                  influencer network.
                </p>
              </div>
            ...
            <div className="row">
              <div className="text-white col-lg-7 about-text newsletter-text">
                ...
                <p class="text-justify">
                  ...
                  targeted traffic to their websites, generate leads, acquire
                  users, engage with their community, build relationships and
                  increase revenue. We strongly believe in social media’s power,
                  which is why we don't only use social media for our clients;
                  we also use it extensively for our brand. Many agencies will
                  tell you they can manage your social media, but they don't
            ...
            <div className="row">
              ...
              <div className="col-lg-7 align-self-center">
                <p class="text-justify">
                  ...
                  Twitter, Snapchat, LinkedIn, TikTok, Instagram, Youtube,
                  Pinterest… As a business, the goal is not to have a profile
                  page on each of them; the goal is to find which ones are the
                  most relevant for your industry and focus on those ones. This
                  is where Pandora can help you. We will choose which social
                  media you should work on and we will use our tools to get the
                  best of those social media. A significant presence on social
            ...
            <div className="row">
              <div className="text-white col-lg-7 about-text">
                <p class="text-justify">
                  ...
                  Pandora, we will manage your media channels to increase your
                ...
                <p class="text-justify">
                  ...
                  makes it easier to reach influencer people. Moreover, it
                  allows you to build a community around your product and brand.
                  Social media is the first place you will get feedback from
            ...
            <div className="row">
              <div className="col-lg-12 about-text">
                ...
                <p class="text-justify">
                  ...
                  gather data, optimize your campaigns to decrease your CPA
                  (Cost per Acquisition) and maximize your results. If you are
                  interested in growing your revenue by outsourcing your digital
                  marketing, particularly your social media strategy, get in
                  touch with Pandora and find out how our SMM (Social media
                  marketing) services can help your business prosper.{" "}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="row">
              <div className="text-white col-lg-12 about-text">
                ...
                <p class="text-justify">
                  ...
                  message to your audience, help you get targeted traffic,
                  generate qualified leads, and increase your revenue. So, what
                  are you waiting for? Get in touch with us to bring your social
                  media strategy to a new level.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="row">
              <div className="text-white col-lg-12 about-text">
                ...
                <p class="text-justify">
                  ...
                  network to barrage the crypto community with powerful
                  messaging that helps promote our clients’ projects.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="row">
              <div className="col-lg-12 about-text">
                ...
                <p class="text-justify">
                  ...
                  connected to top-tier and micro-influencers who can build hype
                  and awareness.
                </p>
              </div>
            </div>
