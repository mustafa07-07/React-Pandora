            ...
            <div className="row">
              <div className="col-lg-6 offset-lg-6 spad about-text">
                ...
                <h5>
                  ...
                  will market your project real good.
                </h5>
                <h5>
          ...
          <div className="container text-white">
            <div className="row">
              <div className="col-lg-7 align-self-center">
                ...
                <h5>
                  The most experienced Digital Marketing team in the space.
                </h5>
              </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-8 newsletter-text">
                ...
                <p class="text-justify">
                  ...
                  easy to reach the top. We cannot give it on a silver plate,
                  but we can support you thoroughly until the end.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="row">
              <div className="col-lg-8 newsletter-text">
                ...
                <p class="text-justify">
                  ...
                  goals, and a shared vision. That’s why we aim to support the
